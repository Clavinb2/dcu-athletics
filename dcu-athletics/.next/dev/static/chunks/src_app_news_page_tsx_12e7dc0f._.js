...
function NewsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NewsPage.useEffect": ()=>{
            const t = setTimeout({
                "NewsPage.useEffect.t": ()=>{
                    setPage(1);
                    fetchPosts();
                }
            }["NewsPage.useEffect.t"], 300);
            return ({
                "NewsPage.useEffect": ()=>clearTimeout(t)
            })["NewsPage.useEffect"];
        }
    }["NewsPage.useEffect"], [
        search,
    ...
    const availableTags = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NewsPage.useMemo[availableTags]": ()=>{
            const s = new Set();
            posts.forEach({
                "NewsPage.useMemo[availableTags]": (p)=>(p.tags || []).forEach({
                        "NewsPage.useMemo[availableTags]": (t)=>s.add(t)
                    }["NewsPage.useMemo[availableTags]"])
            }["NewsPage.useMemo[availableTags]"]);
...
_s(NewsPage, "0Uuw0stIqJRfdtbr1QFXuWDsQDI=");
_c = NewsPage;
var _c;
